...
public class ParagraphVectorsDisjointClasses {
	 private static final Logger log = LoggerFactory.getLogger(ParagraphVectorsTextExample.class);
	   ...
	   public void disjointClasses() throws Exception {
	    	...
	    	*/
	        PrintWriter pw = new PrintWriter("mergedFile_disjointClasses"); 	          
	// BufferedReader for obtaining the disjoint class property that is saved in the respective files
	        BufferedReader br1 = new BufferedReader(new FileReader("disjointClasses123_ontology")); 
	        BufferedReader br2 = new BufferedReader(new FileReader("disjointClasses123_odp")); 	                   
	    	...
	    	File file = new File("mergedFile_disjointClasses");
	 ...
	 //System.out.println("Check the file");- for checking the proper execution of code
	        PrintStream p=new PrintStream(new File("values_disjointClasses")); //for storing the values
	        System.setOut(p);
