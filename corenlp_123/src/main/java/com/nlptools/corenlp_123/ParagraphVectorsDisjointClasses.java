...
public class ParagraphVectorsDisjointClasses {
	 private static final Logger log = LoggerFactory.getLogger(ParagraphVectorsTextExample.class);
	   ...
	   public void disjointClasses() throws Exception {
	...
	// BufferedReader for obtaining the disjoint class property that is saved in the respective files
	        BufferedReader br1 = new BufferedReader(new FileReader(System.getProperty("user.dir")+ "/resources/disjointClasses123_ontology")); 
	        BufferedReader br2 = new BufferedReader(new FileReader(System.getProperty("user.dir")+ "/resources/disjointClasses123_odp")); 	                   
	 ...
	 //System.out.println("Check the file");- for checking the proper execution of code
	        PrintStream p=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/values_disjointClasses")); //for storing the values
	        System.setOut(p);
	        /*After running the Doc2Vec model, the numeric similarity is obtained by using
	         * the cosine similarity. Line0 contains the disjoint class property of the ontology
	         * and its similarity is ran against all the ODPs in the list.
	         * The code is implemented below.The numeric values obtained are saved 
	         * in values_disjointClasses
	         */
