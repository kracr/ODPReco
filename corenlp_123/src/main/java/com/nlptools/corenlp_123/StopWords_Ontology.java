...
//Contributed by Maleeha	
	...
	public void stopWordsDesOntology() {
		...
		try{
		        FileReader fr=new FileReader("stopwords.txt"); //file that has stop Words
		        BufferedReader br= new BufferedReader(fr);
		        while ((sCurrentLine = br.readLine()) != null){
		            stopwords[k]=sCurrentLine; //reading the words and storing in array
		            k++;
		        }
		        InputStream is = new FileInputStream("ontology_description"); // input file
		        ...
		        PrintStream o = new PrintStream(new File("ontology_description")); 		        		        
