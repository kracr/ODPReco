...
public class ParagraphVectors_Signature {
	...
	private static final Logger log = LoggerFactory.getLogger(ParagraphVectorsTextExample.class);
	    ...
	    public void signature() throws Exception {
	         ...
	         */
	        PrintWriter pw = new PrintWriter("mergedFile_signature"); 	          
	        // BufferedReader to obtain the signature files of the ODP and the ontology
	        BufferedReader br1 = new BufferedReader(new FileReader("filteredSignature_ontology")); 
	        BufferedReader br2 = new BufferedReader(new FileReader("filteredSignature_odp")); 	          	          
	       ...
	       // System.out.println("Merged"); ->used for checking the proper execution	    
	    	 ...
	    	 */
	        File file = new File("mergedFile_signature");	    	
	       ...
	       // System.out.println("Check the file");-> used in order to check the code execution
	        PrintStream p=new PrintStream(new File("values_signature"));
	        System.setOut(p);	       
	       /*implementing cosine similarity. After obtaining the vectors, to check the 
	        * similarity of the given ontology with the list of ODPs, cosine similarity 
	        * is used. Line0- has the signature of the ontology and it is being compared
	        * with the ODPs present in the list i.e from Line1-Line 73 respectively
	        */
