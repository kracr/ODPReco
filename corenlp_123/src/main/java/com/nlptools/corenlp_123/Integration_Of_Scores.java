...
public class Integration_Of_Scores {
	...
	public  void integratingScores() throws FileNotFoundException
	   ...
	   */
       ...
       //VALUES_CHAINOFPROPERTY
         ...
         int i2 = 0;
         File file2 = new File("values_chainOfProperty");
         ...
         int i3 = 0;
         File file3 = new File("values_dataPropertyDomain");
         ...
         int i4 = 0;
         File file4 = new File("values_dataPropertyRange");
         ...
         int i5 = 0;
         File file5 = new File("values_description");
         ...
         int i6 = 0;
         File file6 = new File("values_disjointClasses");
   ...
   //Values_ObjectDomainProperty
         ...
         int i7 = 0;
         File file7 = new File("values_objectDomainProperty");
         ...
         int i8 = 0;
         File file8 = new File("values_objectPropertyRange");
         ...
         if (inputFile8 != null) {
            ...
            int i9 = 0;
            File file9 = new File("values_signature");
            ...
            int i10 = 0;
            File file10 = new File("values_subClassProperty123");
            ...
            int i11 = 0;
            File file11 = new File("values_subDataProperty");
            ...
            int i12 = 0;
            File file12 = new File("values_subObjectProperty");
         ...
         //INTEGRATING THE SCORES TOGETHER
            PrintStream p123=new PrintStream(new File("integrated_values"));
            System.setOut(p123);
