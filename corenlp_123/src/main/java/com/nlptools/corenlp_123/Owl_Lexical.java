...
class Owl_Lexical{
	...
	public void owlOntology(String s3) throws OWLOntologyCreationException, OWLOntologyStorageException, IOException {
		...
		//Saving the signature of the ontology in the file
		 PrintStream pq = new PrintStream(new File(System.getProperty("user.dir")+ "/resources/signature_ontology")); 		
		 Set<OWLEntity> p = new HashSet<OWLEntity>();
		 p=o.getSignature();		
		 System.setOut(pq);
		 System.out.print(p);
		 //getting axioms and saving in other file for STRUCTURAL part
		 PrintStream kq=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/structural_ontology"));
		 System.setOut(kq);
		...
		s=s.replaceAll("http://[^>]*/","");
		 System.out.print(s);	
		   ...
		   PrintStream ps1=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/annotationAssert_ontology"));			 
			 System.setOut(ps1);			 
			...
			//DATA PROPERTY DOMAIN
			   PrintStream ps2=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/dataPropertyDomain_ontology"));				 
				...
				s=s.replaceAll("http://[^>]*/","");
				 ...
				 //DATA PROPERTY RANGE
               PrintStream ps3=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/dataPropertyRange_ontology"));				 
				 System.setOut(ps3);			 
				...
				//SUB-PROPERTY CHAIN OF
				 PrintStream ps8=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/chainOf_ontology"));				 
				 System.setOut(ps8);							 
				...
				//SUB-DATA PROPERTY
				PrintStream ps9=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/subDataProperty_ontology")); 
				System.setOut(ps9);			 
