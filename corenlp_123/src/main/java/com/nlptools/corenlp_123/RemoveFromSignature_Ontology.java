...
public class RemoveFromSignature_Ontology {
	public void removeFromSignature_Ont() throws IOException{
		 ...
		 */
		 BufferedReader brf = new BufferedReader(new FileReader(System.getProperty("user.dir")+ "/resources/signature_ontology"));
	     PrintStream ps=new PrintStream(new File(System.getProperty("user.dir")+ "/resources/filteredSignature_ontology"));
