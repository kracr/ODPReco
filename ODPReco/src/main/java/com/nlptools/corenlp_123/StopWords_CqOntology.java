...
public class StopWords_CqOntology {
	...
	public void stopWordsCQOntology() {
		...
		try{
		        FileReader fr=new FileReader(System.getProperty("user.dir")+ "/resources/stopwords.txt"); //file which has stopWords
		        BufferedReader br= new BufferedReader(fr);
		        while ((sCurrentLine = br.readLine()) != null){
		            stopwords[k]=sCurrentLine; //reading the stop words and storing in array
		            k++;
		        }
		        InputStream is = new FileInputStream(System.getProperty("user.dir")+ "/resources/ontology_cq"); //input file
		       ...
		       /*if stop word present in the description, remove it and then traverse for 
		        ...
		        PrintStream o = new PrintStream(new File(System.getProperty("user.dir")+ "/resources/ontology_cq")); 	
