...
public class Integration_Of_Scores {
	...
	public  void integratingScores() throws FileNotFoundException
	   ...
	   */
		//values_cq
         ...
         int i6 = 0;
         File file6 = new File(System.getProperty("user.dir")+ "/resources/disjointClasses123_ontology");
   ...
   //Values_ObjectDomainProperty
         ...
         int i7 = 0;
         File file7 = new File(System.getProperty("user.dir")+ "/resources/objectPropertyDomain_ontology");
         ...
         int i8 = 0;
         File file8 = new File(System.getProperty("user.dir")+ "/resources/objectPropertyRange_ontology");
         ...
         if (inputFile8 != null) {
            ...
            int i9 = 0;
            File file9 = new File(System.getProperty("user.dir")+ "/resources/filteredSignature_ontology");
            ...
            int i10 = 0;
            File file10 = new File(System.getProperty("user.dir")+ "/resources/subclass_ontology");
         ...
         for(int i=0;i<73;i++){
        	 ...
        	 totalAgg[i]=array1[i]+array5[i]+array6[i]+array7[i]+array8[i]+array9[i]+array10[i]+array12[i];
