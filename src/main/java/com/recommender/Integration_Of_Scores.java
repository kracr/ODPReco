...
public class Integration_Of_Scores {
	...
	public  void integratingScores() throws FileNotFoundException
	   ...
	   */
		//values_cq
         ...
         int i5 = 0;
         File file5 = new File(System.getProperty("user.dir")+ "/resources/description_values");
   ...
   //Values_ObjectDomainProperty
         ...
         if (inputFile8 != null) {
            ...
            try {
               inputFile13 = new Scanner(file13);
                  ...
                  System.out.println("File-graph isomorphism not found!");
               }
            if (inputFile13 != null) {
               try {
         ...
         for(int i=0;i<73;i++){
        	 ...
        	 totalAgg[i]=array1[i]+array5[i]+array6[i]+array7[i]+array8[i]+array9[i]+array10[i]+array12[i]+array13[i];
