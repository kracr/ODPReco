...
/*<-----------------------------------------BEHAVIOURAL ANALYSIS-------------------------------------------->
	...
	/*--------------------------------EXECUTION PART------------------------------------------------
     ...
     // The structure of the ontology is analysed by using isomorphism concept
               ...
               Structural_Isomorphism z=new Structural_Isomorphism();
               z.isomorphism();
	 ...
	 */
	  ...
	  */
	    ...
	    */
        ...
        BufferedReader br2f = new BufferedReader(new FileReader(System.getProperty("user.dir")+ "/resources/lucene_recowithIRI")); 	          	          
