...
/*<------------------------------------------Lexical Analysis------------------------------------------------>
  ...
  */
       ...
       if(input_description.isEmpty()){
    	   FileWriter des_empty=new FileWriter(System.getProperty("user.dir")+ "/resources/description_values");
			for(int x=1;x<74;x++){
				des_empty.write("0");
				des_empty.write("\n");
					   }
...
/*<-----------------------------------------BEHAVIOURAL ANALYSIS-------------------------------------------->
	 ...
	 */
	  ...
	  * Lucene is the other approach we have followed for recommendations. It creates index file and matches 
	  * the recommends the top 5 documents which are semantically similar
	  */
	    LuceneTester lt=new LuceneTester();
	    lt.lucene_recommender();
	    
	   /*Ordering lucene in the order of ODPs and assigning weights 
	     * we order lucene scores based on odp list and then, we give weights.
	     * For lucene, weight assigned is 0.6 and for doc2vec, it is 0.4. Then we
	     * add the two weights and among these ODPs are recommended to user 
	     */
	    
	    OrderLuceneODPsAndAssignWeight ow=new OrderLuceneODPsAndAssignWeight();
	    ow.orderAndWeight();
       ...
       //sorting the file 
        ...
        BufferedReader br_final=new BufferedReader(new FileReader(System.getProperty("user.dir")+ "/resources/recommender"));
   ...
   PrintWriter reco_final = new PrintWriter(System.getProperty("user.dir")+ "/resources/final_sorted_reco"); 	          
   String line_reco=brodpreco.readLine();
	String sreco="";
	 ...
	 BufferedReader bfinc=new BufferedReader(new FileReader(System.getProperty("user.dir")+"/resources/final_sorted_reco"));
